    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-700">
          ...
          <div>
            <h1 className="text-sm font-bold text-white leading-tight">QA Management</h1>
            <p className="text-xs text-slate-400">Suite</p>
          </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          <p className="px-3 mb-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">Main Menu</p>
          {navItems.map((item) => (
            <NavLink
              key={item.path}
              to={item.path}
